...
<img src="D:\Learning\Gunners-Java\Part2\2.多线程\pic\普通锁阻塞与Condition阻塞示意图.jpg" style="zoom:80%; float: left" />
...
每个调用await()方法的线程都会被挂到相应队列中阻塞，直到被signal()唤醒
...
- 释放同步状态（释放锁）
  ...
  - 从全局的角度，可以看作是线程Rt1节点，释放同步状态后，从同步队列挪到等待队列队尾，但实际上等待队列队尾的线程Ct5节点是新构造出来的，同步队列的节点Rt1并不会真的挪到等待队列队尾

  <img src="D:\Learning\Gunners-Java\Part2\2.多线程\pic\await队列节点移动流程.jpg" style="zoom:80%; float: left" />
